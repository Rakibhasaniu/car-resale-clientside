            ...
            <div className="">
                <section className="my-8 dark:bg-gray-800 dark:text-gray-100 pb-10">
                    <div className="container flex flex-col items-center mx-auto  md:p-10 md:px-12">
                        <h1 className="p-4 text-4xl font-semibold leading-none text-center">FeedBack Costomer</h1>
                    </div>
                        ...
                        <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg">
                            <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 dark:bg-gray-900">
                                <p className="relative px-6 py-1 text-lg italic text-center dark:text-gray-100">
                                    ...
                                    </svg>The BMW 3 Series is one of the best posh saloon cars on sale, it’s packed with tech, is great to drive and spacious enough for a family of four. Some options are rather pricey but every version, excepting the base model, comes standard with an 8-speed automatic gearbox.
                            ...
                            <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 dark:bg-gray-900">
                                <p className="relative px-6 py-1 text-lg italic text-center dark:text-gray-100">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="w-8 h-8 dark:text-violet-400">
                                        <path d="M232,246.857V16H16V416H54.4ZM48,48H200V233.143L48,377.905Z"></path>
                                        <path d="M280,416h38.4L496,246.857V16H280ZM312,48H464V233.143L312,377.905Z"></path>
                                    </svg>Electric cars offer smooth and quiet progress allied to instantaneous responsiveness, thanks in part to not needing to change gears. The Tesla Model 3 is one of the best EVs on sale today and aside from the odd build quality issue, offers a range of strengths including breath-taking performance and a funky minimalist interior.   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="absolute right-0 w-8 h-8 dark:text-violet-400">
                                        <path d="M280,185.143V416H496V16H457.6ZM464,384H312V198.857L464,54.1Z"></path>
                                        <path d="M232,16H193.6L16,185.143V416H232ZM200,384H48V198.857L200,54.1Z"></path>
                                    </svg>
                                </p>
                            ...
                            <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 dark:bg-gray-900">
                                <p className="relative px-6 py-1 text-lg italic text-center dark:text-gray-100">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="w-8 h-8 dark:text-violet-400">
                                        <path d="M232,246.857V16H16V416H54.4ZM48,48H200V233.143L48,377.905Z"></path>
                                        <path d="M280,416h38.4L496,246.857V16H280ZM312,48H464V233.143L312,377.905Z"></path>
                                    </svg>Purists will tell you to pick a manual transmission in a sporty car like the Porsche Cayman, but the seven-speed PDK automatic transmission offers sharper responses and is far less work when you’re stuck in traffic. It does add to the already rather spicy base price though.
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="absolute right-0 w-8 h-8 dark:text-violet-400">
                                        <path d="M280,185.143V416H496V16H457.6ZM464,384H312V198.857L464,54.1Z"></path>
                                        <path d="M232,16H193.6L16,185.143V416H232ZM200,384H48V198.857L200,54.1Z"></path>
                                    </svg>
                ...
                <section className="dark:bg-gray-800 dark:text-gray-100 lg:px-20 pb-10">
                    <h2 className="text-3xl font-bold text-center py-5 ">Ours Resell Car Buy To Company</h2>
