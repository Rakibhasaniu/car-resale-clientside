  ...
  return (
    <>
      <section className=" dark:bg-gray-800 dark:text-gray-50 py-10">
        ...
        <p className="text-[22px] text-amber-600 text-center pb-5">
          Click Those Image To See Full Image{" "}
        </p>
              ...
              <PhotoProvider>
                <div className="foo">
                  <PhotoView key={i} src={imgs?.img}>
                    <img
                      className="w-full cursor-grab h-full rounded shadow-sm min-h-48 dark:bg-gray-500 aspect-square"
                      src={imgs?.img}
                      alt=""
                    />
                  </PhotoView>
