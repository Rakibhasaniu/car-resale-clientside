...
const Cards = ({ services, index }) => {
  return (
    <>
      <div className="card max-w-[300px]  bg-red-900 shadow-xl mt-3">
        <PhotoProvider>
          <div className="foo">
        ...
        <div className="card-body">
          ...
          <div className="card-actions justify-between">
            ...
            <Link
              to={`/card_details/${services?._id}`}
              className=" px-8 py-[6px] btn-secondary rounded-lg text-[15px] text-[#fafafa]"
            >
              Details
            </Link>
          </div>
